...
export default function CreateCharity() {
    ...
    return (
      ...
      <div className="flex">
            ...
            <input id="charityNameInput" value={formState.charityName} onChange={handleInputChange} name="charityName" type="text" />
            {/* <span>Description</span> */}
            <input id="descriptionInput" value={formState.description} onChange={handleInputChange} name="description" type="text" />
            {/* <span>Goal</span> */}
            <input id="goalInput" value={formState.goal} onChange={handleInputChange} name="goal" type="number" />
            {/* <span>Stripe</span> */}
            <input id="stripeLinkInput" value={formState.stripeLink} onChange={handleInputChange} name="stripeLink" placeholder="insert hyperlink" type="text" />
